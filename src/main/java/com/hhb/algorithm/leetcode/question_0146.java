...
public class question_0146 {
    ...
    public question_0146(int capacity) {
        this.linkedHashMap = new LinkedHashMap<Integer, Integer>(capacity + 1, DEFAULT_LOAD_FACTOR, true) {
            @Override
    ...
    public static void main(String[] args) {
        question_0146 lRUCache = new question_0146(2);
        lRUCache.put(1, 1); // 缓存是 {1=1}
        lRUCache.put(2, 2); // 缓存是 {1=1, 2=2}
